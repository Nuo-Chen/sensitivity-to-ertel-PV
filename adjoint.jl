...
function adj_Rϕ(psi_bs::Array{T,3}, target::Array{T,3}, dx::T, dy::T, 
                h::Array{T,3}, mf::Array{T,3}, A::T, f::Array{T,3}) where {T<:AbstractFloat}
...
function adj_Rψ(phi_bs::Array{T,3}, target::Array{T,3}, dx::T, dy::T, 
                h::Array{T,3}, mf::Array{T,3}, A::T) where {T<:AbstractFloat}
...
function adj_Tϕ(target::Array{T,3}, dx::T, dy::T, mf::Array{T,3}) where {T<:AbstractFloat}
...
"""target is q̂"""
function φP(target::Array{T,3}, psi_bs::Array{T,3}, phi_bs::Array{T,3}, h::Array{T,3},
            dx::T, dy::T, mf::Array{T,3}, A::T, f::Array{T,3} ) where {T<:AbstractFloat}
...
"""target is ϕ̂"""
function UB(arget::Array{T,3}, psi_bs::Array{T,3}, phi_bs::Array{T,3}, h::Array{T,3},
            dx::T, dy::T, mf::Array{T,3}, A::T, f::Array{T,3} ) where {T<:AbstractFloat}
