...
# ╔═╡ 2fa96038-de03-11ec-0c46-832e16572b97
begin
	using NPZ
	using JuMP, Ipopt
	using Statistics
...
# ╔═╡ 2cdc754a-6ca5-4e45-83fd-771078e13778
...
# ╔═╡ 0e7dccee-aaee-4f03-8281-70be94ae9dd4
begin
...
# ╔═╡ 0c2c7034-a437-4576-9bb9-19ddc53320b1
begin
...
# ╔═╡ bf39cb10-9e30-4f1b-b4c5-bf468c0aaa4c
begin
...
# ╔═╡ a2a6e7a6-8604-4ea7-a1a6-a08abbd7b895
begin
	itv = 4
	idx = [1,3, 11, 17, 20]
...
# ╔═╡ 85ec70ae-a16f-43cd-ab7f-2dd44a8c4bb1
rhs = adjm.UP(ψ̂5, ψ5, ϕ5, rdx, rdy, msfm5, f5);

# ╔═╡ 2011f0ef-83c7-43eb-82a1-f7aa0f48cfff
begin
	igabs = abs.(rhs[:,:,end])
	mean(igabs)
	#String("mean of initial guess for buffer layers")
end 

# ╔═╡ ec48faa2-f70f-4103-8914-8b5202f5547b
begin
...
# ╔═╡ 0715c793-a08d-43f4-a03a-08432cf50aed
begin
	...
	rhs_vec = vec(rhs_ext)
	@objective(md, Min, (φP * vec(a) - rhs_vec).^2 )
	optimize!(md)
	a_fin = value.(a)
